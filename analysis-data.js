const ANALYSIS = {
  problems: [
    ...
    { category: '데이터 관리', items: [
      ...
      { title: '블랙리스트 통제 부재', desc: '서류 위조/신원 부적격자 적발 후 수동 기록만 가능, 재가입 원천 차단 시스템 없어 동일 인물이 재유입 가능', severity: 'critical' },
      { title: '재컨텍 DB 출처 미구분', desc: '정회원 만료·가입보류·장기상담·부재중 등 다양한 사유로 재유입되는 DB의 출처가 구분되지 않아 영업 우선순위 혼선', severity: 'high' },
      { title: '개인정보 파기 미수립', desc: '탈회/종료 후 데이터 수동 관리로 법정 보유 기간(정회원 5년/준회원 1년) 준수 여부 확인 불가, 파기 누락 빈발', severity: 'critical' }
    ]},
    { category: '업무 프로세스', items: [
      ...
      { title: '장기상담 DB 홀딩', desc: '매니저가 가망 고객 DB를 무기한 보유(홀딩) 가능하여 타 매니저 영업 기회 차단 및 전환율 하락', severity: 'high' },
      { title: '잔금미납 방치', desc: '계약만 체결 후 잔금이 미납되어도 시스템 통제 없이 무기한 방치 → 허수 계약 누적', severity: 'critical' },
      { title: '탈회 처리 SLA 부재', desc: '탈회 접수 후 환불 정산 처리 기한이 없어 무기한 지연, 법적 분쟁 소지 및 고객 불만 증가', severity: 'high' },
      { title: '프로필 무분별 발송', desc: '미인증/보류/소송중 회원에게도 프로필 발송이 가능하여 개인정보 유출 및 매칭 오류 발생', severity: 'critical' },
      { title: '분배 후 미컨텍 방치', desc: '신규 DB 분배 후 매니저가 첫 연락을 시도하지 않아도 통제 수단 부재 → DB 방치 및 전환율 하락', severity: 'high' }
    ]},
  ...
  improvements: [
    ...
    { area: '블랙리스트 관리', before: '서류 위조 적발 후 수동 기록만 가능, 재가입 차단 체계 부재', after: 'UID 기반 영구 차단 + 휴대폰/주민번호 해시(Hash) 자동 대조 → 가입 원천 차단 + 검색 결과 영구 제외', impact: '부적격자 재유입 원천 차단, 정회원 풀 신뢰도 보호', dept: '인증/법무/관리자', priority: 'Critical' },
    { area: '장기상담 제어', before: '매니저가 가망 DB를 무기한 보유(홀딩) 가능', after: '90일×2회(최대 180일) 유지 → 만료 시 미분배 풀 강제 회수 + 60일 쿨타임 재배정 차단', impact: 'DB 독점 방지, 전환율 향상, 공정한 영업 기회 분배', dept: '상담/관리자', priority: 'High' },
    { area: '가입보류 제어', before: '방문 후 가입 보류 상태를 무기한 유지 가능', after: '30일×1회 제한 → 미결제 시 [방문 미결제 DB] 태그 + 공용 DB 풀 방출', impact: '방문 고객 결제 전환 촉진, 방치 DB 제로', dept: '상담/관리자', priority: 'High' },
    { area: '잔금미납 통제', before: '계약만 체결 후 잔금 미납 상태 무기한 방치', after: '14일 1차 경고 알림 → 30일 경과 시 자동 [탈회진행] 전환 + 법무/정산팀 이관', impact: '허수 계약 제거, 실매출 정확도 향상', dept: '상담/정산/법무', priority: 'Critical' },
    { area: '탈회 SLA', before: '탈회 접수 후 환불 정산 처리 기한 없음, 무기한 지연 빈발', after: '접수일 기준 7영업일 내 정산 완료 필수 + 초과 시 법무/정산팀 자동 SLA 경고 발송', impact: '법적 분쟁 소지 차단, 고객 만족도 향상', dept: 'CS/정산/법무', priority: 'High' },
    { area: '프로필 발송 통제', before: '미인증/보류/소송중 회원에게도 프로필 발송 가능', after: '상태별 프로필 Lock 자동 적용 + 소송중 시 기발송 URL 무효화 + 교제중 타회원 발송 차단', impact: '개인정보 유출 차단, 매칭 사고 방지', dept: '매칭/법무', priority: 'Critical' },
    { area: '재컨텍 출처 관리', before: '재유입 DB 출처 미구분, 우선순위 없이 랜덤 분배', after: '4종 출처 태그(정회원만료/가입보류/장기상담/부재중) + 우선순위별 분배 전략 + 쿨타임 자동 적용', impact: '고가치 DB 우선 처리, 고객 피로도 관리', dept: '상담/관리자', priority: 'High' },
    { area: '개인정보 파기', before: '탈회/종료 후 데이터 수동 관리, 법정 보유 기간 준수 불확실', after: '정회원 5년/준회원 1년 법정 보유 → 매월 자동 파기 배치 + 블라인드(해싱/마스킹) 처리 + 파기 로그 영구 보존', impact: '개인정보보호법 100% 준수, 보안 감사 대응', dept: '전체/법무', priority: 'Critical' },
    { area: '분배 상한선', before: '매니저 1인에게 무제한 DB 배정 가능, 업무 과부하 발생', after: '일일 20건/월간 200건 상한 + 초과 시 분배 자동 스킵 + 48시간 미컨텍 경고 + 72시간 팀장 알림', impact: '균등 업무 배분, 신규 DB 방치 제로', dept: '상담/관리자', priority: 'High' },
    { area: '업그레이드/다운그레이드', before: '프로그램 등급 변경 시 절차 미수립, 전산 혼선 발생', after: '인증 전: 기존 계약 취소 + 신규 재작성 / 인증 후: 전산 내 단계업그레이드 기능 활용 + 매칭 이력 유지', impact: '등급 변경 시 정산 정확도 향상, 전산 무결성 보장', dept: '인포/상담/경영', priority: 'Medium' },
    { area: '서류 반려 프로세스', before: '인증팀 반려 시 매니저 수동 확인 필요, 별도 게시판 작성', after: '반려 즉시 매니저 자동 알림 + 7일 보완 기한 타이머 + 미보완 시 자동 가입 파기', impact: '반려 처리 속도 향상, 위조 서류 재심사 체계화', dept: '인증/상담', priority: 'High' }
  ],
  apis: [
    {
  ...
  policy: {
    sections: [
      ...
      { id:'member-ops', title:'2. 회원 정책 및 운영', items:[
        ...
        {sub:'2.6 업그레이드 및 다운그레이드 정책', note:'가입 절차 진행 도중 회원이 프로그램 등급을 변경할 때의 전산 처리 기준입니다. 변경 시점(인증 전/후)에 따라 처리 방식이 완전히 달라집니다.', table:{
          headers:['구분','적용 시점','시스템 처리 방식','비고'],
          rows:[
            ['인증 전 변경','계약 직후 ~ 서류 인증 완료 전','기존 계약을 전산에서 완전히 [취소/무효화] 처리 → 변경된 등급으로 [신규 계약서 재작성] 후 절차를 처음부터 재진행','계약서·결제·서류 전부 초기화'],
            ['인증 후 변경','서류 인증 완료 및 서비스 개시 후','기존 계약을 파기하지 않고 전산 내 [단계 업그레이드] 기능 활용하여 변경 → 기존 매칭 이력·컨택 히스토리 그대로 유지','차액 정산 자동 계산']
          ]
        }, points:[
          '<strong style="color:#dc2626">핵심 원칙</strong>: 인증 전 변경은 "처음부터 다시", 인증 후 변경은 "이력 유지한 채 등급만 전환"',
          '<strong>인증 전 변경 상세</strong>: 기존 계약을 전산에서 완전히 취소/무효화 처리한 뒤, 변경된 등급으로 신규 계약서를 재작성하고 절차(결제·서류접수·인증)를 처음부터 다시 밟아야 합니다.',
          '<strong>인증 후 변경 상세</strong>: 기존 계약을 파기하지 않고 전산 내의 [단계 업그레이드] 기능을 활용하여 변경합니다. 이를 통해 기존에 진행했던 <strong>매칭 이력과 컨택 히스토리</strong>를 그대로 유지할 수 있습니다.',
          '⚠️ 인증 후 등급 변경 시 차액 정산은 변경 시점의 프로그램 요금 기준으로 자동 계산되며, 추가 납부 또는 환불 처리가 수반됩니다.'
        ]},
        {sub:'2.7 프로필 발송 규칙', note:'프로필은 회원의 개인정보가 포함된 민감 자료이므로, 발송 자격·시점·차단 조건을 엄격히 통제합니다.', table:{
          headers:['구분','조건','시스템 처리','비고'],
          rows:[
            ['상태값 발송 락(Lock)','[신규], [인증중], [활동대기] 상태','시스템상 소개장(프로필) 발송 기능 비활성화 — URL 생성 자체 차단','서류 인증 미완료 또는 2가입 대기 중인 회원 보호'],
            ...
            ['<strong style="color:#dc2626">3일 무응답 자동거절</strong>','프로필 발송 후 72시간(3일) 경과','상대 회원이 수락(OK)/거절 미응답 시 시스템 자동 거절 처리 또는 매니저에게 재발송 팝업 표시','RL-011 룰 엔진 연동'],
            ...
            ['<strong style="color:#dc2626">사진 보정 금지</strong>','프로필 사진 등록 시','매니저가 임의로 회원 사진을 과도하게 보정하여 업로드하는 행위 엄격 금지 — 실물과 사진 괴리로 인한 클레임·소비자보호원 민원 방지','위반 시 인사 조치']
          ]
        }},
      ...
      { id:'withdrawal', title:'8. 탈회 및 환불 정책', items:[
        ...
        {sub:'8.5 비정상 상태 회원의 탈회 접수 차단 정책', note:'현재 활발히 서비스를 받고 있는 상태가 아닌 회원의 탈회/환불 접수를 시스템적으로 원천 차단하여 불필요한 전산 처리와 정산 오류를 방지합니다.', table:{
          headers:['차단 대상 상태','상태 설명','차단 사유','시스템 처리'],
          rows:[
            ['활동대기','1가입 종료 후 2가입 진행 대기','활성 서비스 미진행 상태 — 탈회 대상 계약이 아님','탈회/환불 접수 버튼 비활성화(Disabled)'],
            ['만료(기간만료)','기간제 만료일 도래','이미 서비스가 종료된 상태 — 환불 대상 없음','탈회/환불 접수 버튼 비활성화'],
            ['자동만료','활동대기 3개월 경과','시스템 자동 만료 처리 완료 상태','탈회/환불 접수 버튼 비활성화'],
            ['약정만료','횟수제 약정횟수 소진','1가입 횟수 소진 완료 — 잔여 서비스 없음','탈회/환불 접수 버튼 비활성화'],
            ['탈회','탈회금 전액 지급 종결','이미 탈회 절차가 완료된 상태 — 중복 접수 불가','탈회/환불 접수 버튼 비활성화 + 재접수 불가 안내 메시지']
          ]
        }, points:[
          '<strong style="color:#dc2626">UI 차단 원칙</strong>: 위 상태의 회원 상세 화면에서는 [탈회 접수] 및 [환불 신청] 버튼이 시스템적으로 비활성화(Disabled)되어 클릭 자체가 불가합니다.',
          '<strong>예외 처리</strong>: 관리자(본부장급 이상)가 특수 사유로 접수해야 하는 경우, [관리자 강제 접수] 기능을 통해서만 가능하며 사유 입력이 필수입니다.',
          '<strong>접수 가능 상태</strong>: [활동], [임시교제], [교제], [외부교제], [약정보류], [임시보류], [장기보류], [강제보류] 상태의 회원만 정상적으로 탈회 접수가 가능합니다.',
          '<strong>감사 로그</strong>: 관리자 강제 접수 건은 별도 감사 로그에 자동 기록되며, 월간 보안 점검 대상에 포함됩니다.'
        ]}
      ]},
      ...
      { id:'matching-filter-policy', title:'12. 등급별 매칭 필터링 및 검색 제어 정책', items:[
        {sub:'12.1 정책 목적', points:[
          '매칭 매니저의 <strong>임의 주선을 시스템적으로 방지</strong>하고, 등급별 매칭 품질을 보장하기 위한 검색 제한 규칙입니다.',
          '본 정책은 <strong style="color:#dc2626">시스템 룰 엔진에 하드코딩</strong>되어 매니저가 임의로 우회하거나 변경할 수 없도록 설계됩니다.',
          '등급 체계: 브론즈 → 실버 → 골드 → 다이아 → 블랙/시크릿(VVIP) 순서로 상위 등급이 결정됩니다.'
        ]},
        {sub:'12.2 +1단계 검색 룰 (일반/준전문직)', note:'일반 및 준전문직 회원의 매칭 검색 범위를 제한하여 등급별 서비스 품질을 보장합니다.', table:{
          headers:['회원 등급','검색 가능 범위','검색 차단 범위','예시'],
          rows:[
            ['브론즈','브론즈 ~ 실버(+1단계)','골드 이상 전체 차단','브론즈 여성 → 실버 남성까지만 검색 가능'],
            ['실버','실버 ~ 골드(+1단계)','다이아 이상 차단','실버 여성 → 골드 남성까지만 검색 가능'],
            ['골드','골드 ~ 다이아(+1단계)','블랙/시크릿 차단','골드 여성 → 다이아 남성까지만 검색 가능'],
            ['다이아','다이아 ~ 블랙(+1단계)','시크릿 차단','다이아 여성 → 블랙 남성까지만 검색 가능']
          ]
        }, points:[
          '<strong style="color:#dc2626">하드코딩 규칙</strong>: 매칭 매니저가 검색 화면에서 대상자를 조회할 때, 본인 등급 기준 딱 <strong>1단계 상향</strong>까지만 검색 결과에 노출됩니다.',
          '시스템은 검색 쿼리 실행 시 자동으로 등급 필터를 적용하며, 매니저가 필터를 해제하거나 우회할 수 없습니다.',
          '⚠️ 하위 등급 검색은 제한 없음 — 골드 여성은 브론즈~다이아 남성까지 검색 가능'
        ]},
        {sub:'12.3 전문직 매칭 블라인드 제어', note:'전문직 프로그램 회원에 대한 비대칭 검색 권한을 정의합니다.', table:{
          headers:['구분','검색 주체','검색 대상','검색 허용 여부','시스템 처리'],
          rows:[
            ['전문직 남성 → 여성','전문직 남성','모든 등급 여성','<strong style="color:#059669">✅ 전체 허용</strong>','등급 제한 없이 전체 여성 프로필 검색·열람 가능'],
            ['골드 이상 여성 → 전문직 남성','골드/다이아/블랙/시크릿 여성','전문직 남성','<strong style="color:#059669">✅ 허용</strong>','전문직 남성 프로필이 검색 결과에 정상 노출'],
            ['브론즈/실버 여성 → 전문직 남성','브론즈/실버 여성','전문직 남성','<strong style="color:#dc2626">🚫 원천 차단</strong>','전문직 남성이 검색 결과에서 완전 블라인드(비노출) 처리']
          ]
        }, points:[
          '<strong>비대칭 설계 이유</strong>: 전문직 프로그램은 프리미엄 요금을 지불한 회원 전용 서비스이므로, 해당 회원의 프로필이 무분별하게 노출되지 않도록 보호합니다.',
          '<strong style="color:#dc2626">블라인드 원칙</strong>: 브론즈·실버 등급 여성의 시스템에서는 전문직 남성이 <strong>원천 차단(블라인드)</strong>되어 검색·열람·매칭 요청 모두 불가합니다.',
          '매칭 매니저가 수동으로 블라인드를 해제하거나 우회 매칭하는 것은 시스템적으로 차단됩니다.'
        ]},
        {sub:'12.4 무제한 오픈 (VVIP/특수 프로모션)', note:'최상위 등급 및 특수 프로모션 회원에 대한 매칭 범위 예외를 정의합니다.', table:{
          headers:['대상 회원','등급/유형','매칭 검색 범위','비고'],
          rows:[
            ['블랙 등급','VVIP','등급 제한 없이 전체 매칭 풀 접근','전문직 포함 모든 등급 검색 가능'],
            ['시크릿 등급','VVIP','등급 제한 없이 전체 매칭 풀 접근','별도 전담 매칭 매니저 배정'],
            ['기타-자산가','특수 프로모션','등급 제한 없이 전체 매칭 풀 접근','자산 검증 완료 후 적용'],
            ['특수 프로모션','이벤트/시즌 프로모션','등급 제한 없이 전체 매칭 풀 접근','관리자 설정에 의해 기간 한정 적용']
          ]
        }, points:[
          '<strong>무제한 오픈 조건</strong>: 블랙/시크릿 등 VVIP나 특수 프로모션(기타-자산가 등) 회원은 등급 제한 없이 <strong>전체 매칭 풀</strong>에 접근할 수 있습니다.',
          '무제한 오픈은 시스템 관리자가 해당 회원의 프로그램/등급을 설정할 때 자동으로 적용되며, 별도 승인 절차 없이 즉시 반영됩니다.'
        ]},
        {sub:'12.5 매칭 필터 권한 매트릭스', table:{
          headers:['기능','일반 매니저','매칭 매니저','팀장','관리자'],
          rows:[
            ['등급 필터 해제','✕','✕','✕','✕ (시스템 하드코딩)'],
            ['전문직 블라인드 해제','✕','✕','✕','✕ (시스템 하드코딩)'],
            ['VVIP 무제한 오픈 설정','✕','✕','✕','● (프로그램 설정 시 자동)'],
            ['매칭 검색 실행','✕','●','●','●'],
            ['매칭 결과 열람','✕','●','●','●']
          ]
        }}
      ]},
      { id:'roadmap', title:'13. 향후 이행 계획', steps:['설계: 보안/DB 정책을 개발 규격서(Spec)에 반영 확정','구현: UID 통합 DB + 필드 암호화 + RLS + 룰 엔진 개발','테스트: 브랜드 격리 검증 + 임계값 상태 전이 테스트','배포: AS-IS 데이터 시계열 변환 + 마스터 DB 이관','사후: 법정 파기 로그 점검 + 보안 감사 정례화'] }
    ],
